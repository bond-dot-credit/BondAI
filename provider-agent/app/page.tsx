      ...
      <div className="relative bg-black py-20 min-h-screen flex items-center">
        ...
        <div className="container mx-auto px-4 relative z-10 pt-20">
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            ...
            <div className="md:w-1/2 space-y-8">
              ...
              <div className="text-center md:text-left space-y-4">
                ...
                <p className="text-base md:text-lg text-gray-400">
                  Discover verifiable credit scoring that helps AI agents capitalize and scale the agentic economy through confidential computation.
                </p>
              </div>
            ...
            {/* Right side - Contract Links & Resources */}
            <div className="md:w-1/2">
              <div className="bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-sm rounded-xl border border-slate-700/50 p-8 space-y-6">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-slate-400">Deployed contracts and resources</p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  {/* ACP Contract */}
                  <a
                    href="https://sepolia.basescan.org/address/0x959591Bab069599cAbb2A72AA371503ba2d042FF"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-white">ACP Contract</p>
                        <p className="text-xs text-slate-400 font-mono">0x9595...2FF</p>
                      </div>
                    </div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-white">ERC-8004 Registry</p>
